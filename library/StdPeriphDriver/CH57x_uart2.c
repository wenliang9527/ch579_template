...
{	
    UART2_BaudRateCfg( 19200 );
    R8_UART2_FCR = (1<<6) | RB_FCR_TX_FIFO_CLR | RB_FCR_RX_FIFO_CLR | RB_FCR_FIFO_EN;		// FIFO打开，触发点4字节2=(1<<6)
   // R8_UART2_LCR = RB_LCR_WORD_SZ;	
    R8_UART2_LCR = RB_LCR_WORD_SZ|RB_LCR_PAR_MOD|RB_LCR_PAR_EN;	//RB_LCR_PAR_MOD=0x10偶检验
