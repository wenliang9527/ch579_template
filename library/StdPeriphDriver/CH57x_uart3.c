...
{	
    UART3_BaudRateCfg( 19200 );
    R8_UART3_FCR = (1<<6) | RB_FCR_TX_FIFO_CLR | RB_FCR_RX_FIFO_CLR | (RB_FCR_FIFO_EN);		// FIFO打开，触发点4字节
    R8_UART3_LCR = RB_LCR_WORD_SZ|RB_LCR_PAR_MOD|RB_LCR_PAR_EN;	//数据8位｜偶校验0X10｜4位为1（校验打开）
